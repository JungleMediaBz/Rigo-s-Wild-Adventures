...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const tourData = {
    ...
    'garifuna-cooking-cheil-waterfall': {
      ...
      price: '$168 US',
      description: "A full day packed with culture and flavor! Start with a hands-on Garifuna cooking class, then discover the world of bean-to-bar chocolate at Cheil. Finish your amazing day with a refreshing dip in the cool waters of a Mayan World waterfall.",
      image: 'images/9.jpeg',
      duration: 'Full Day',
      groupSize: 'Minimum 3 people',
      included: ['Lunch', 'Tour Guide', 'Fees', 'Transportation', 'One bottle of water each'],
    ...
    'mestizo-cooking-cheil-chocolate': {
      ...
      price: '$130 US',
      description: "A day dedicated to Belizean flavors! First, master the art of traditional Mestizo cooking in a fun, hands-on class. Then, switch from savory to sweet with a fascinating bean-to-bar tour at Cheil Chocolate, where you'll make your own chocolate.",
      image: 'images/10.jpeg',
    ...
    'banana-farm-cheil-chocolate': {
      ...
      price: '(Pending)',
      description: "Explore two of Belize's most important and delicious crops. Start with a fascinating tour of a working banana farm to see how this fruit is grown and prepared for export. Then, switch gears for a hands-on chocolate making class at Cheil Chocolate.",
      image: 'images/11.jpeg',
      duration: 'Full Day',
      groupSize: 'Minimum 3 people',
      included: ['Lunch', 'Tour Guide', 'Fees', 'One bottle of water each'],
