...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const tourData = {
    ...
    'cheil-chocolate-half-day': {
      ...
      image: 'images/Half Day Cheil.jpg',
      duration: '8AM to 1PM',
      groupSize: 'Minimum 3 people',
    ...
    'zipline-cheil-chocolate': {
      ...
      image: 'images/Zipline Mayan World + Cheil chocolate.jpg',
      duration: '8AM to 3:30PM',
      groupSize: 'Minimum 3 people',
      included: ['Lunch', 'Tour Guide', 'Fees', 'Transportation', 'One bottle of water each'],
      bring: [
    ...
    'ixcacao-chocolate-spice-farm': {
      ...
      image: 'images/Ixcacao Chocolate + Spice Farm.jpg',
      duration: '8AM to 5PM',
      groupSize: 'Minimum 3 people',
      included: ['Lunch', 'Tour Guide', 'Fees', 'Transportation', 'One bottle of water each'],
      bring: [
    ...
    'ixcacao-chocolate-spice-farm-waterfall': {
      ...
      image: 'images/Ixcacao Chocolate + Spice Farm + Waterfall.jpg',
    ...
    'chocolate-classes': {
      ...
      image: 'images/Chocolate classes.jpg',
      duration: '1.5 hours',
      groupSize: 'Minimum 3 people',
    ...
    'mestizo-cooking-waterfall': {
      ...
      image: 'images/Mestizo cooking + Mayan world waterfall.jpg',
      duration: 'Approx. 5-6 hours',
      groupSize: 'Minimum 3 people',
      included: ['Lunch', 'Tour Guide', 'Fees', 'Transportation', 'One bottle of water each'],
      bring: [
    ...
    'banana-farm-waterfall': {
      ...
      image: 'images/Banana farm tour.jpg',
      duration: 'Full Day',
      groupSize: 'Minimum 3 people',
